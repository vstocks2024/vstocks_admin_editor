...
export type TextEditorElement = EditorElementBase<
  ...
  // export type ShapeEditorElement=EditorElementBase<"circle"|"Rect">
...
export type family_variants_arr={
'100':'Thin',
...
export const FAMILY_VARIANTS=z.object({
  variants:z.enum(['100','100italic','200','200italic','300','300italic','regular','italic'
...
export const ANIMATIONS_DATA=z.object({

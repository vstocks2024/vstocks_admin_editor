...
export const Arrange = observer(() => {
  ...
  return (
   ...
   <h3 className='widgetheading'>Arrange</h3>
     ...
     <button onClick={handleBringToFront}  type='button'>
        <RiBringToFront size={24}/>
      </button>
      <button onClick={handleBringForward} type='button'>
        <RiBringForward size={24}/>
      </button>
      <button onClick={handleSendBackward} type='button'>
        <RiSendBackward size={24}/>
      </button>
      <button onClick={handleSendToBack}  type='button'>

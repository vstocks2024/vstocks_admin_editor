...
export const ImageResource = observer(
  ({ fileid, filename, filesource, index }: ImageResourceProps) => {
    ...
    const delRef = React.useRef<HTMLButtonElement>(null);
    ...
    useEffect(()=>{
      delRef.current?.addEventListener("click",handleImageDeleteButton);
      return ()=>{
        // eslint-disable-next-line react-hooks/exhaustive-deps
        delRef.current?.removeEventListener("click",handleImageDeleteButton);
      }
